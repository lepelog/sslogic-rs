...
match self {
Exit::AncientCistern_To_AncientCisternBoss => Entrance::AncientCisternBoss_From_AncientCistern,
Exit::AncientCistern_To_FloriaWaterfall => Entrance::FloriaWaterfall_From_AncientCistern,
Exit::AncientCisternBoss_To_AncientCisternCandleRoom => Entrance::AncientCisternCandleRoom_From_AncientCisternBoss,
...
Exit::ParrowAndOriellesHouse_To_Skyloft => Entrance::Skyloft_From_ParrowAndOriellesHouse,
...
Exit::Skyloft_To_ParrowAndOriellesHouse => Entrance::ParrowAndOriellesHouse_From_Skyloft,
...
Exit::EarthTempleBoss_To_EarthTempleSpring => Entrance::EarthTempleSpring_From_EarthTempleBoss,
Exit::EarthTempleSpring_To_EldinVolcano => Entrance::EldinVolcano_From_EarthTempleSpring,
Exit::EldinSilentRealm_To_EldinVolcano => Entrance::EldinVolcano_From_EldinSilentRealm,
Exit::EldinVolcano_To_Sky_EldinEntranceStatue => Entrance::Sky_From_EldinVolcano_EldinEntranceStatue,
Exit::EldinVolcano_To_InsideVolcanoSummit => Entrance::InsideVolcanoSummit_From_EldinVolcano,
...
Exit::EldinVolcano_To_Sky_TempleEntranceStatue => Entrance::Sky_From_EldinVolcano_TempleEntranceStatue,
Exit::EldinVolcano_To_MogmaTurf_Skydive => Entrance::MogmaTurf_From_EldinVolcano_Skydive,
Exit::EldinVolcano_To_Sky_VolcanoEastStatue => Entrance::Sky_From_EldinVolcano_VolcanoEastStatue,
Exit::EldinVolcano_To_EldinSilentRealm => Entrance::EldinSilentRealm_From_EldinVolcano,
Exit::EldinVolcano_To_Sky_VolcanoAscentStatue => Entrance::Sky_From_EldinVolcano_VolcanoAscentStatue,
...
Exit::DeepWoods_To_Sky_ForestTempleStatue => Entrance::Sky_From_DeepWoods_ForestTempleStatue,
...
Exit::FaronWoods_To_Sky_FaronWoodsEntryStatue => Entrance::Sky_From_FaronWoods_FaronWoodsEntryStatue,
Exit::FaronWoods_To_GreatTree_LowerPlatform => Entrance::GreatTree_From_FaronWoods_LowerPlatform,
Exit::FaronWoods_To_GreatTree_UpperPlatform => Entrance::GreatTree_From_FaronWoods_UpperPlatform,
Exit::FaronWoods_To_GreatTree_Top => Entrance::GreatTree_From_FaronWoods_Top,
Exit::FaronWoods_To_Sky_GreatTreeStatue => Entrance::Sky_From_FaronWoods_GreatTreeStatue,
...
Exit::FaronWoods_To_Sky_InTheWoodsStatue => Entrance::Sky_From_FaronWoods_InTheWoodsStatue,
Exit::FaronWoods_To_Sky_ViewingPlatformStatue => Entrance::Sky_From_FaronWoods_ViewingPlatformStatue,
Exit::GreatTree_To_FaronWoods_Tunnel => Entrance::FaronWoods_From_GreatTree_Tunnel,
Exit::GreatTree_To_FaronWoods_LowerPlatform => Entrance::FaronWoods_From_GreatTree_LowerPlatform,
Exit::GreatTree_To_FaronWoods_UpperPlatform => Entrance::FaronWoods_From_GreatTree_UpperPlatform,
Exit::GreatTree_To_FaronWoods_Top => Entrance::FaronWoods_From_GreatTree_Top,
Exit::FireSanctuaryA_To_OutsideFireSanctuary => Entrance::OutsideFireSanctuary_From_FireSanctuaryA,
Exit::FireSanctuaryA_To_FireSanctuaryBoss => Entrance::FireSanctuaryBoss_From_FireSanctuaryA,
...
Exit::FireSanctuaryBoss_To_FireSanctuaryFlameRoom => Entrance::FireSanctuaryFlameRoom_From_FireSanctuaryBoss,
Exit::InsideGoddessStatue_To_Skyloft => Entrance::Skyloft_From_InsideGoddessStatue,
Exit::KnightAcademy_To_Skyloft_LowerDoors => Entrance::Skyloft_From_KnightAcademy_LowerDoors,
Exit::KnightAcademy_To_Skyloft_UpperDoors => Entrance::Skyloft_From_KnightAcademy_UpperDoors,
...
Exit::Skyloft_To_KnightAcademy_LowerDoors => Entrance::KnightAcademy_From_Skyloft_LowerDoors,
Exit::Skyloft_To_KnightAcademy_UpperDoors => Entrance::KnightAcademy_From_Skyloft_UpperDoors,
...
Exit::FloriaWaterfall_To_AncientCistern => Entrance::AncientCistern_From_FloriaWaterfall,
...
Exit::FloriaWaterfall_To_Sky_FloriaWaterfallStatue => Entrance::Sky_From_FloriaWaterfall_FloriaWaterfallStatue,
Exit::LakeFloria_To_Sky_LakeFloriaStatue => Entrance::Sky_From_LakeFloria_LakeFloriaStatue,
...
Exit::LanayruDesert_To_Sky_DesertEntranceStatue => Entrance::Sky_From_LanayruDesert_DesertEntranceStatue,
Exit::LanayruDesert_To_FireNode => Entrance::FireNode_From_LanayruDesert,
Exit::LanayruDesert_To_LanayruMiningFacilityA => Entrance::LanayruMiningFacilityA_From_LanayruDesert,
Exit::LanayruDesert_To_LanayruSilentRealm => Entrance::LanayruSilentRealm_From_LanayruDesert,
Exit::LanayruDesert_To_LightningNode => Entrance::LightningNode_From_LanayruDesert,
Exit::LanayruDesert_To_Sky_NorthDesertStatue => Entrance::Sky_From_LanayruDesert_NorthDesertStatue,
Exit::LanayruDesert_To_Sky_StoneCacheStatue => Entrance::Sky_From_LanayruDesert_StoneCacheStatue,
Exit::LanayruDesert_To_TempleOfTime_End => Entrance::TempleOfTime_From_LanayruDesert_End,
Exit::LanayruDesert_To_LanayruCaves => Entrance::LanayruCaves_From_LanayruDesert,
Exit::LanayruDesert_To_Sky_WestDesertStatue => Entrance::Sky_From_LanayruDesert_WestDesertStatue,
Exit::LanayruDesert_To_TempleOfTime_Start => Entrance::TempleOfTime_From_LanayruDesert_Start,
Exit::LightningNode_To_LanayruDesert => Entrance::LanayruDesert_From_LightningNode,
Exit::TempleOfTime_To_LanayruDesert_End => Entrance::LanayruDesert_From_TempleOfTime_End,
Exit::TempleOfTime_To_LanayruDesert_Start => Entrance::LanayruDesert_From_TempleOfTime_Start,
Exit::LanayruMines_To_Sky_LanayruMineEntryStatue => Entrance::Sky_From_LanayruMines_LanayruMineEntryStatue,
...
Exit::LanayruMiningFacilityA_To_LanayruDesert => Entrance::LanayruDesert_From_LanayruMiningFacilityA,
Exit::LanayruMiningFacilityA_To_LanayruMiningFacilityB_Hub2 => Entrance::LanayruMiningFacilityB_From_LanayruMiningFacilityA_Hub2,
Exit::LanayruMiningFacilityA_To_LanayruMiningFacilityB_HubW => Entrance::LanayruMiningFacilityB_From_LanayruMiningFacilityA_HubW,
Exit::LanayruMiningFacilityA_To_LanayruMiningFacilityB_Hub => Entrance::LanayruMiningFacilityB_From_LanayruMiningFacilityA_Hub,
Exit::LanayruMiningFacilityB_To_LanayruMiningFacilityBoss => Entrance::LanayruMiningFacilityBoss_From_LanayruMiningFacilityB,
Exit::LanayruMiningFacilityBoss_To_LanayruMiningFacilityToToT => Entrance::LanayruMiningFacilityToToT_From_LanayruMiningFacilityBoss,
Exit::LanayruMiningFacilityToToT_To_TempleOfTime => Entrance::TempleOfTime_From_LanayruMiningFacilityToToT,
Exit::InsidePiratesStronghold_To_OutsidePiratesStronghold_End => Entrance::OutsidePiratesStronghold_From_InsidePiratesStronghold_End,
Exit::InsidePiratesStronghold_To_OutsidePiratesStronghold_Beginning => Entrance::OutsidePiratesStronghold_From_InsidePiratesStronghold_Beginning,
Exit::OutsidePiratesStronghold_To_InsidePiratesStronghold_End => Entrance::InsidePiratesStronghold_From_OutsidePiratesStronghold_End,
Exit::OutsidePiratesStronghold_To_InsidePiratesStronghold_Beginning => Entrance::InsidePiratesStronghold_From_OutsidePiratesStronghold_Beginning,
Exit::OutsidePiratesStronghold_To_SandSea => Entrance::SandSea_From_OutsidePiratesStronghold,
Exit::SandSea_To_OutsidePiratesStronghold => Entrance::OutsidePiratesStronghold_From_SandSea,
...
Exit::SandSeaDocks_To_Sky_AncientHarbor => Entrance::Sky_From_SandSeaDocks_AncientHarbor,
Exit::SandSeaDocks_To_LanayruCaves => Entrance::LanayruCaves_From_SandSeaDocks,
Exit::Shipyard_To_ShipyardConstructionBay_Upper => Entrance::ShipyardConstructionBay_From_Shipyard_Upper,
Exit::Shipyard_To_SandSea => Entrance::SandSea_From_Shipyard,
Exit::Shipyard_To_ShipyardConstructionBay_Lower => Entrance::ShipyardConstructionBay_From_Shipyard_Lower,
Exit::ShipyardConstructionBay_To_Shipyard_Lower => Entrance::Shipyard_From_ShipyardConstructionBay_Lower,
Exit::ShipyardConstructionBay_To_Shipyard_Upper => Entrance::Shipyard_From_ShipyardConstructionBay_Upper,
...
Exit::LanayruSilentRealm_To_LanayruDesert => Entrance::LanayruDesert_From_LanayruSilentRealm,
Exit::MogmaTurf_To_EldinVolcano_EndVent => Entrance::EldinVolcano_From_MogmaTurf_EndVent,
Exit::MogmaTurf_To_EldinVolcano_StartVent => Entrance::EldinVolcano_From_MogmaTurf_StartVent,
...
Exit::BehindTheTemple_To_SealedGroundsSpiral => Entrance::SealedGroundsSpiral_From_BehindTheTemple,
Exit::BehindTheTemple_To_SealedTemple => Entrance::SealedTemple_From_BehindTheTemple,
Exit::BehindTheTemple_To_Sky_BehindTheTempleStatue => Entrance::Sky_From_BehindTheTemple_BehindTheTempleStatue,
Exit::SealedGroundsSpiral_To_SealedTemple => Entrance::SealedTemple_From_SealedGroundsSpiral,
Exit::SealedGroundsSpiral_To_Sky_SealedGroundsStatue => Entrance::Sky_From_SealedGroundsSpiral_SealedGroundsStatue,
...
Exit::SealedTemple_To_SealedGroundsSpiral => Entrance::SealedGroundsSpiral_From_SealedTemple,
...
Exit::Sky_To_BehindTheTemple_BehindTheTempleStatue => Entrance::BehindTheTemple_From_Sky_BehindTheTempleStatue,
Exit::Sky_To_DeepWoods_DeepWoodsStatue => Entrance::DeepWoods_From_Sky_DeepWoodsStatue,
Exit::Sky_To_DeepWoods_ForestTempleStatue => Entrance::DeepWoods_From_Sky_ForestTempleStatue,
Exit::Sky_To_EldinVolcano_EldinEntranceStatue => Entrance::EldinVolcano_From_Sky_EldinEntranceStatue,
Exit::Sky_To_EldinVolcano_TempleEntranceStatue => Entrance::EldinVolcano_From_Sky_TempleEntranceStatue,
Exit::Sky_To_EldinVolcano_VolcanoEastStatue => Entrance::EldinVolcano_From_Sky_VolcanoEastStatue,
Exit::Sky_To_EldinVolcano_VolcanoAscentStatue => Entrance::EldinVolcano_From_Sky_VolcanoAscentStatue,
Exit::Sky_To_FaronWoods_FaronWoodsEntryStatue => Entrance::FaronWoods_From_Sky_FaronWoodsEntryStatue,
Exit::Sky_To_FaronWoods_GreatTreeStatue => Entrance::FaronWoods_From_Sky_GreatTreeStatue,
Exit::Sky_To_FaronWoods_InTheWoodsStatue => Entrance::FaronWoods_From_Sky_InTheWoodsStatue,
Exit::Sky_To_FaronWoods_ViewingPlatformStatue => Entrance::FaronWoods_From_Sky_ViewingPlatformStatue,
Exit::Sky_To_FloriaWaterfall_FloriaWaterfallStatue => Entrance::FloriaWaterfall_From_Sky_FloriaWaterfallStatue,
...
Exit::Sky_To_LakeFloria_LakeFloriaStatue => Entrance::LakeFloria_From_Sky_LakeFloriaStatue,
Exit::Sky_To_LanayruDesert_DesertEntranceStatue => Entrance::LanayruDesert_From_Sky_DesertEntranceStatue,
Exit::Sky_To_LanayruDesert_NorthDesertStatue => Entrance::LanayruDesert_From_Sky_NorthDesertStatue,
Exit::Sky_To_LanayruDesert_StoneCacheStatue => Entrance::LanayruDesert_From_Sky_StoneCacheStatue,
Exit::Sky_To_LanayruDesert_WestDesertStatue => Entrance::LanayruDesert_From_Sky_WestDesertStatue,
Exit::Sky_To_LanayruMines_LanayruMineEntryStatue => Entrance::LanayruMines_From_Sky_LanayruMineEntryStatue,
Exit::Sky_To_OutsideFireSanctuary_InsideTheVolcanoStatue => Entrance::OutsideFireSanctuary_From_Sky_InsideTheVolcanoStatue,
Exit::Sky_To_SealedGroundsSpiral_SealedGroundsStatue => Entrance::SealedGroundsSpiral_From_Sky_SealedGroundsStatue,
...
Exit::InsideVolcanoSummit_To_EldinVolcano => Entrance::EldinVolcano_From_InsideVolcanoSummit,
Exit::InsideVolcanoSummit_To_OutsideFireSanctuary => Entrance::OutsideFireSanctuary_From_InsideVolcanoSummit,
Exit::InsideVolcanoSummit_To_VolcanoSummitWaterfall => Entrance::VolcanoSummitWaterfall_From_InsideVolcanoSummit,
Exit::OutsideFireSanctuary_To_FireSanctuaryA => Entrance::FireSanctuaryA_From_OutsideFireSanctuary,
Exit::OutsideFireSanctuary_To_Sky_InsideTheVolcanoStatue => Entrance::Sky_From_OutsideFireSanctuary_InsideTheVolcanoStatue,
Exit::OutsideFireSanctuary_To_InsideVolcanoSummit => Entrance::InsideVolcanoSummit_From_OutsideFireSanctuary,
Exit::VolcanoSummitWaterfall_To_InsideVolcanoSummit => Entrance::InsideVolcanoSummit_From_VolcanoSummitWaterfall,
}
}
pub fn requirement_key(&self) -> RequirementKey {
match self {
...
Exit::SandSeaDocks_To_Sky_AncientHarbor => RequirementKey::SandSeaDocks_To_Sky_AncientHarbor,
